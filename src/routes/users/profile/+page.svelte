    ...
    <div class="fu d2">
        ...
        <div id="panel-password">
            ...
            <div class="mb-4">
                ...
                <div id="strengthBar" class="flex gap-1.5 mb-2">
                    <div class="str-seg flex-1 rounded-full"></div>
                    <div class="str-seg flex-1 rounded-full"></div>
                    <div class="str-seg flex-1 rounded-full"></div>
                </div>
                <div class="flex items-center justify-between">
                    <span id="strengthLabel" class="text-[11px] font-medium text-chalk-muted dark:text-[#6A7FA0]"></span>
                    <div id="strengthHints" class="text-[10px] text-chalk-muted dark:text-[#6A7FA0]"></div>
                </div>
                </div>
            </div>
            ...
            <div class="bg-chalk-2 dark:bg-[#1A2438] rounded-xl p-4 mb-6 tt">
                ...
                <div id="rule-len" class="flex items-center gap-2 text-[11px] text-chalk-muted dark:text-[#6A7FA0]">
                    <span class="rule-dot w-1.5 h-1.5 rounded-full bg-chalk-4 dark:bg-white/20 flex-shrink-0"></span>At least 8 characters
                </div>
                <div id="rule-upper" class="flex items-center gap-2 text-[11px] text-chalk-muted dark:text-[#6A7FA0]">
                    <span class="rule-dot w-1.5 h-1.5 rounded-full bg-chalk-4 dark:bg-white/20 flex-shrink-0"></span>One uppercase letter
                </div>
                <div id="rule-num" class="flex items-center gap-2 text-[11px] text-chalk-muted dark:text-[#6A7FA0]">
                    <span class="rule-dot w-1.5 h-1.5 rounded-full bg-chalk-4 dark:bg-white/20 flex-shrink-0"></span>One number
                </div>
                <div id="rule-sym" class="flex items-center gap-2 text-[11px] text-chalk-muted dark:text-[#6A7FA0]">
                    <span class="rule-dot w-1.5 h-1.5 rounded-full bg-chalk-4 dark:bg-white/20 flex-shrink-0"></span>One special character
                </div>
                </div>
            </div>
