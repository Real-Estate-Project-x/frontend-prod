<script lang="ts">
        ...
        <div class="max-w-[780px] mx-auto flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          <div>
            <div class="flex items-center gap-3 mb-2 flex-wrap">
                <p class="text-[10px] font-medium tracking-[.18em] uppercase text-blue-bright">Editing listing</p>
                <span class="live-badge"><span class="w-1.5 h-1.5 rounded-full bg-sage pulse-dot"></span>Live</span>
              </div>
            ...
            <h1 class="font-display font-light text-white leading-[1.05]" style="font-size:clamp(26px,3.5vw,40px)">
              Edit <em class="italic text-gold">property.</em>
            </h1>
            <p class="text-[13px] font-light text-white/50 mt-1.5">
                Update any details below. Changes take effect immediately after saving.
            </p>
          </div>
          <div class="flex items-center gap-3 flex-shrink-0">
            ...
            <a href="/agency/listings" class="flex items-center gap-1.5 text-[12px] font-medium text-white/70 border border-white/20 hover:border-white/40 hover:text-white px-4 py-2 rounded-full tt no-underline">
                <svg width="11" height="11" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"><path d="M9 2L4 7l5 5"></path></svg>
                Back to listing
            </a>
          </div>
        </div>
  ...
  <style>
      ...
      /* live status badge */
    .live-badge{background:#EFF3EE;color:#4A7848;border:1px solid rgba(74,120,72,.25);border-radius:20px;padding:3px 10px;font-size:10px;font-weight:600;display:inline-flex;align-items:center;gap:5px}
    .dark .live-badge,
    :global([data-theme="dark"]) .live-badge{background:rgba(74,120,72,.2);color:#7DBF7A;border-color:rgba(74,120,72,.3)}
