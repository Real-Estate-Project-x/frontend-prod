...
<aside id="dashSb" 
  ...
  <div class="px-5 pt-6 pb-5 border-b border-chalk-3 dark:border-white/[0.06]">
    <div class="flex items-center gap-3 mb-4">
      <div class="relative flex-shrink-0">
        <div class="w-12 h-12 rounded-full bg-navy-strong flex items-center justify-center text-[15px] font-medium text-white ring-2 ring-blue-bright/25">CO</div>
      ...
      <div class="min-w-0">
        <div class="text-[14px] font-medium text-navy-dark dark:text-blue-100 truncate">Chukwuemeka Okafor</div>
    ...
    <div class="bg-chalk-2 dark:bg-[#1A2438] rounded-xl p-3 tt">
      <div class="text-[11px] text-chalk-muted dark:text-[#6A7FA0] mb-1">Premier Properties PH</div>
  ...
  <nav class="px-3 py-4 flex-1">
    ...
    <a href="#" class="sb-link flex items-center gap-3 px-3 py-[9px] rounded-xl mb-0.5 text-[13px] text-chalk-muted dark:text-[#6A7FA0] no-underline tt cursor-pointer">
      <svg class="w-[15px] h-[15px] flex-shrink-0" viewBox="0 0 20 20" fill="none"><path d="M3 4h14a1 1 0 011 1v8a1 1 0 01-1 1H5.5L2 16.5V5a1 1 0 011-1z" stroke="currentColor" stroke-width="1.4" stroke-linejoin="round"/></svg>
      Enquiries <span class="ml-auto text-[10px] font-medium bg-blue-bright/15 text-blue-bright px-2 py-[2px] rounded-full flex items-center gap-0.5"><span class="w-1.5 h-1.5 rounded-full bg-blue-bright pulse-dot"></span>3 new</span>
    </a>
